...
def GetAllowedSecurityVersions():
    return jsonify({
        "data": ["0.360.0pcplayer", "0.450.0pcplayer", "0.463.0pcplayer", "0.271.1pcplayer",]
    })
...
def GetAllowedMD5Hashes():
    ...
    if apiKey == "dac86da7-a4bc-4bff-8ca4-8b54e1ac925b": # 2021
        return jsonify({
            "data": [
                "sussysigma420ohiomeowmeowMrrpohioSussy",# 2020
    ...
    return jsonify({
        "data": [
            # 2016
            "6d1340e66bd89d5abf463376fe3367cf",
            # 2018,
            "8830ab5d9ef6a42aee70952a98f5d940" # ts shit so skidded
            ]
    })
